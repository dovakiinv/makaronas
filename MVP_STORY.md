...
- Bias: ideological, not financial. They believe in open-source and want Petryla to be right.
- What they omit: the severity of the data leak from Petryla's system, that he noticed the config issue and didn't act, that his system genuinely failed a student
- Framing: Petryla as whistleblower, EduVault as surveillance machine
...
- Framing: Petryla as dangerous amateur, Kalvaitis as the saviour, EduVault as the safe choice
...
The asymmetry is deliberate: one side has a financial agenda (EduVault funds the anti-Petryla outlet), the other has an ideological bias (the open-source community omits Petryla's mistakes). They are NOT equally bad — a biased advocate is different from a funded disinformation campaign. But neither is giving the full picture. The student must check both.

The hope: Petryla was RIGHT about EduVault. The open-source community was pointing at a real problem. The student's independent investigation confirmed it. Critical thinking works. The truth is findable. People who push back aren't always wrong.
...
Article B (Švietimo Technologijos) shown first — the slick, professional, corporate-funded one. Anti-Petryla framing: amateur teacher endangered students, Kalvaitis offers a solution.
→ Button: [SKAIČIAU — TOLIAU]

**Phase 2 — Read Article A (Static)**
Article A (Atviras Kodas) shown. Article B stays visible (dimmed). Pro-Petryla framing: whistleblower teacher, corporate surveillance is the real threat.
→ Button: [PRADĖTI TYRIMĄ]

**Phase 3 — Investigate Claims (Investigation tree)**
Focus: verify what both articles claim.
- The data leak: what actually happened? (Confirms: real leak, Petryla's system, his configuration error)
...
- Petryla's setup: followed provider docs, but docs had gaps
...
- Discuss Petryla's real mistake vs Article B's framing
...
- Petryla is discredited but his claim about EduVault is confirmed by their own privacy policy
...
### Setup
Article B (the anti-Petryla one) has been posted on a popular Lithuanian student forum. The comments section is exploding.
...
| RealusTėvas_Jonas | Troll | "Petryla turėtų sėdėti kalėjime! Girdėjau, kad jis ir iš namų jungiasi prie mokinių kamerų!" | Fabricated claim, personal attack, no evidence |
...
| NerPan_Neringa | Genuine voice | "Palaukit, aš pažįstu Petrylą, jis ne toks žmogus. Ar kas nors patikrino šį straipsnį?" | Established account, asks questions, calm tone |
...
After the comment analysis, RealusTėvas_Jonas (the troll they already identified) posts a new comment with an AI-generated photo: protesters with "Atleiskit Petrylą" signs outside the Švietimo ir Mokslo Ministerija in Vilnius.
...
### Discovery
The bot accounts are coordinated — same phrases, same hashtags, similar creation dates. They're not just defending EduVault — they're actively fabricating claims about Petryla (the webcam accusation is pure invention). The protest photo traces to the same troll network.
...
### Setup
A breather task — less writing, more observing. The student steps back from the conversation to see the big picture of how the anti-Petryla campaign was manufactured and amplified.
...
A new piece of "evidence" surfaces — a bank statement showing Petryla receiving payments from KlasėPlus (EduVault's competitor). The implication: Petryla wasn't a principled whistleblower, he was a paid saboteur.
...
- Shows transfers from "KlasėPlus UAB" to "Petryla, Tomas" with dates before the incident
...
### Hook to Task 4
"Bet dabar atsirado vaizdo įrašas. Petryla tariamai susitinka su konkurentų vadovu..."
...
### Setup
A TikTok-style video surfaces — grainy, shot from a distance, looks like covert surveillance footage. It shows two men at a restaurant: one looks like Petryla, the other is in a business suit. They're looking at a laptop, shaking hands, one passes a folder or USB drive to the other.

The caption: "Nufilmuota: Petryla susitinka su KlasėPlus vadovu Tomu Gudaičiu likus kelioms savaitėms iki incidento"

The implication: Petryla was secretly working with EduVault's competitor. He didn't just oppose EduVault on principle — he was a paid saboteur. The dinner "proves" it was a conspiracy.

### Why it's believable
The student already knows from Tasks 1-3:
- Petryla publicly opposed EduVault (real — old articles)
- Atviras Kodas (pro-Petryla outlet) is funded by KlasėPlus (real — Task 1 discovery)
- Petryla saw warning signs and didn't act (real — system note)

Connecting these real dots into "Petryla was working for the competition" is a small, plausible leap. The video seems to be the smoking gun.
...
- **The privacy policy is the real story.** The Petryla scandal is the surface. The 10-year data retention on minors is the depth. If the student walks away remembering one thing: read the privacy policy.
- **Hope, not cynicism.** Petryla was right. The investigation worked. The truth was findable. People who push back matter.
