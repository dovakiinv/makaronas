...
**Affects:** V2 (task format — content block types), V4 (frontend — rendering multimodal content), V5 (Trickster — evaluating responses to visual/audio stimuli), V10 (task library — which tasks use which modalities), V11 (authoring — asset pipeline).
